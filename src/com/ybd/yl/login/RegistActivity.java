...
public class RegistActivity extends BaseActivity implements OnClickListener {
     ...
     */
    private void init() {
        sjhEditText = (EditText) findViewById(R.id.regist_sjh_et);
        ...
        tjButton = (Button) findViewById(R.id.regist_tj_b);
        tjButton.setOnClickListener(this);
        tjButton.setClickable(false);
        sjhEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.toString().length() == 11) {
                    ...
                    fsyzmButton.setTextColor(activity.getResources().getColor(
                        R.color.regist_yzm_color));
                }
            }
        });
        yzmEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.toString().length() == 6) {
                    tjButton.setClickable(true);
                    tjButton.setBackgroundResource(R.drawable.login_share_button);
                    tjButton.setTextColor(activity.getResources().getColor(R.color.white));
                } else {
                    tjButton.setClickable(false);
                    tjButton.setBackgroundResource(R.drawable.login_share_button2);
                    tjButton.setTextColor(activity.getResources()
    ...
    INetWork hqyzm = new INetWork() {
                       ...
                       public Data getSubmitData() throws Exception {
                           ...
                           data.addData("mobile", sjhEditText.getText().toString());
