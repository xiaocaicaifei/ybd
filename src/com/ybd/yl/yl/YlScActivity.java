 ...
 */
public class YlScActivity extends BaseActivity implements OnClickListener {
    ...
    private void initTpGridView(){
      //更多按钮
        ...
        tpAdapter = new YlScAdapter(list, activity);
...
//                bxButton.setBackgroundResource(R.drawable.yl_share_button3);
            ...
            case R.id.qrsc_b:
                ...
                NetWork.submit(YlScActivity.this, new UploadFile(l, new INetWorkResult() {
                    @Override
