 ...
 */
public class YlIndexPlAdapter extends BaseAdapter {
    private List<Map<String, Object>> list        = new ArrayList<Map<String, Object>>();
    private Activity                  activity;
    ImageLoader                       imageLoader = ImageLoader.getInstance();

    public YlIndexPlAdapter(List<Map<String, Object>> list, Activity activity) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(activity).inflate(R.layout.yl_index_pl_item, null);// 这个过程相当耗时间
