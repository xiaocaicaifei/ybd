...
import com.ybd.common.defined.HistogramView;
 ...
 */
public class YlSjtjActivity extends BaseActivity{

    private HistogramView gzrtxzztHistogramView;//估值人，条形柱状图
    private PieChart mChart; 
    @Override
    protected void initComponentBase() {
        setContentView(R.layout.yl_sjtj);
        init();
    }
     ...
     */
    private void init(){
        gzrtxzztHistogramView=(HistogramView) findViewById(R.id.gzrtxtjt_hv2);
