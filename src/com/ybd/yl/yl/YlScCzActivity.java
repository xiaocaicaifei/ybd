...
public class YlScCzActivity extends BaseActivity implements OnClickListener {
    ...
    protected void initComponentBase() {
        setContentView(R.layout.yl_sc_cz);
        initPublicView("充值");
        init();
    }
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            ...
            case R.id.wxzf_ll:
                ...
                intent.setClass(activity, YlScCzcgActivity.class);
