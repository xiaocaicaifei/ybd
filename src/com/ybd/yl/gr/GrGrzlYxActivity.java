 ...
 */
public class GrGrzlYxActivity extends BaseActivity implements OnClickListener {

    private EditText yxEditText;//邮箱
    
    @Override
    protected void initComponentBase() {
        setContentView(R.layout.gr_grzl_yx);
        initPublicView("邮箱", R.drawable.login_fh, "保存", null, this);
        init();
    }
     ...
     */
    private void init() {
        yxEditText=(EditText) findViewById(R.id.qm_et);
        yxEditText.setText(this.getIntent().getExtras().getString("nr"));
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.right_rl:
                ...
                intent.putExtra("nr", yxEditText.getText().toString());
