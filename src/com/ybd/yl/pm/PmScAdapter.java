 ...
 */
public class PmScAdapter extends BaseAdapter {
    private List<Map<String, Object>> list        = new ArrayList<Map<String, Object>>();
    private Activity                  activity;
    ImageLoader                       imageLoader = ImageLoader.getInstance();

    public PmScAdapter(List<Map<String, Object>> list, Activity activity) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(activity).inflate(R.layout.pm_sc_item, null);// 这个过程相当耗时间
