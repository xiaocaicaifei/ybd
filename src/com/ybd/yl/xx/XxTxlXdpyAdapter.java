 ...
 */
public class XxTxlXdpyAdapter extends BaseAdapter {
    private List<Map<String, Object>> list        = new ArrayList<Map<String, Object>>();
    private XxTxlXdpyActivity         activity;
    private ImageLoader               imageLoader = ImageLoader.getInstance();

    public XxTxlXdpyAdapter(List<Map<String, Object>> list, XxTxlXdpyActivity activity) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(activity).inflate(R.layout.xx_txl_xdpy_list_item,
                null);// 这个过程相当耗时间
        ...
        //        }
        if (PaseJson.getMapMsg(map, "ep").equals("0")) {
