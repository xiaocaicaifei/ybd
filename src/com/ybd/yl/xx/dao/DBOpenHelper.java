...
public class DBOpenHelper extends SQLiteOpenHelper
{
	...
	{
	    //聊天的用户表(用户id,用户的名字，用户头像，该用户未读消息数量，最后一次聊天的时间，最后一次聊天的内容,聊天用户的聊天的ID)
		db.execSQL("create table tb_talk_user (id integer primary key,userid text,username text,usericon text,unreadnum integer,lasttalktime text,lasttalkmsg text,voipaccount text)");
