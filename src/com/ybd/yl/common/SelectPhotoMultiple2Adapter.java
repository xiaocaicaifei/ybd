 ...
 */
public class SelectPhotoMultiple2Adapter extends BaseAdapter {
    private List<Map<String, Object>> list        = new ArrayList<Map<String, Object>>();
    private Activity                  activity;
    private ImageLoader               imageLoader = ImageLoader.getInstance();
    WindowManager                     wm;
    private OnClickListener selectListener;
    public SelectPhotoMultiple2Adapter(List<Map<String, Object>> list, Activity activity,OnClickListener clickListener) {
        this.list = list;
