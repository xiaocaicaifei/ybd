 ...
 * 
 * @author cyf
 * @version $Id: StringUtil.java, v 0.1 2011-6-3 上午09:43:01 cyf Exp $
 */
public class StringUtil {
    ...
    public static String intTo8Hex(int a) {
        ...
        String outStr = hexStr.substring(6, 8) + hexStr.substring(4, 6) + hexStr.substring(2, 4)
